...
createChannel(){
    ...
    peer channel create -o localhost:7150 -c $CHANNEL_NAME \
...
updateAnchorPeers(){
    setGlobalsForPeer0Org1
    peer channel update -o localhost:7150 --ordererTLSHostnameOverride orderer.private.com -c $CHANNEL_NAME -f ./artifacts/channel/${CORE_PEER_LOCALMSPID}anchors.tx --tls $CORE_PEER_TLS_ENABLED --cafile $ORDERER_CA
